// Shared contact block: name, phone, email, social links.
export default function ContactDetails({
  ...
  return (
    <div className={`flex flex-col items-start gap-8 text-left ${className}`}>
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          >
            <g clipPath="url(#clip0_contact_li)">
              <path
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clipPath="url(#clip0_contact_ig)">
              <path
