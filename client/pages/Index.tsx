...
const HOME_MARQUEE_IMAGES = [
  "/assets/Resources/home_page_marque/1.jpg",
  "/assets/Resources/home_page_marque/2.jpg",
  "/assets/Resources/home_page_marque/3.jpg",
  "/assets/Resources/home_page_marque/4.jpg",
  "/assets/Resources/home_page_marque/5.jpg",
  "/assets/Resources/home_page_marque/6.jpg",
];
      ...
      <div className="flex flex-col gap-16 pt-16 lg:gap-[150px] lg:pt-[80px]">
        ...
        <section className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-12">
            {/* Left: list items + para */}
            <div className="flex flex-col gap-8 lg:shrink-0">
              <motion.div className="flex flex-col gap-1" {...fadeUp(0.1)}>
              ...
              <motion.p
                className="font-heading font-normal text-[15px] leading-[1.58] tracking-[0px] text-left text-ink lg:max-w-[380px]"
                {...fadeUp(0.15)}
              >
            ...
            {/* Right: paintings marquee */}
            <div className="overflow-hidden flex-1">
              <div className="flex gap-4 animate-marquee w-max">
                {[...HOME_MARQUEE_IMAGES, ...HOME_MARQUEE_IMAGES].map((src, i) => (
                  <img
                    key={i}
                    src={src}
                    alt=""
